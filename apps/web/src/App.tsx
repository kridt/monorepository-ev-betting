    ...
    <div className="min-h-screen bg-dark-950 text-dark-100">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    'nav-link relative px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300',
                    isActive
                      ? 'text-white bg-gradient-to-r from-red-600/20 to-orange-600/20'
                      : 'text-dark-400 hover:text-white hover:bg-dark-800/50'
                  )
                }
              >
                {({ isActive }) => (
                  <>
                    ...
                    {isActive && <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-8 h-0.5 bg-gradient-to-r from-red-500 to-orange-500 rounded-full"></span>}
                  </>
                )}
              </NavLink>
              <NavLink
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Routes>
          ...
          <Route path="/hidden" element={<Removed />} />
